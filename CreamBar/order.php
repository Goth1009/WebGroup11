...
<head>
    ...
    <title>Cream bar - order page</title>
    <style type="text/css">
        ...
        <section class="products">
            <div class="box-container">
                <div class="title">
                    ...
                    <h1>my orders</h1>
                    <p>bsvsdv ivcsbvdisdvs subsivbsv svdcbsvb</p>
                </div>
            </div>
            <div class="box-container">
                <?php
                ...
                <div class="box" <?php if ($fetch_order['status'] == 'cancel') { echo 'style="border:2px solid red;"'; } ?>>
                    <a href="view_order.php?get_id=<?= $fetch_order['id']; ?>">
                        ...
                        <div class="row">
                            ...
                            <p class="status" style="color:<?php if ($fetch_order['status'] == 'delivered') { echo 'pink'; } elseif ($fetch_order['status'] == 'canceled') { echo 'red'; } else { echo 'orange'; } ?>">
                                <?= $fetch_order['status']; ?>
                            </p>
                        </div>
                    </a>
