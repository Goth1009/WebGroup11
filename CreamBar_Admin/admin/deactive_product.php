...
<head>
  ...
  <title>Ice-Cream Bar Admin Pannel - All Deactive Products Page</title>
</head>
<body>
<?php include '../components/admin_header.php'; ?>
  ...
  <div class="main">
    ...
    <div class="title2">
      <a href="home.php">dashboard</a><span> / deactive products</span>
    </div>
    <section class="show-post">
      <h1 class="heading">deactive products</h1>
      <div class="box-container">
        <?php
          $select_product = $conn->prepare("SELECT * FROM `products` where status = 'deactive' ");
